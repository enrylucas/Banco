...
class Monstro(tag: Tag) extends Table[(String,Int,Int,Int,Long,Boolean,Int,Int,Int,Int,Float,Float,Boolean,Boolean)](tag,"monstro"){
  ...
  def * = (nome,vida,foco,estamina,almas,hollow,forca,destreza,inteligencia,fe,defesaFisica,defesaMagica,ressuscita,chefe)
}
